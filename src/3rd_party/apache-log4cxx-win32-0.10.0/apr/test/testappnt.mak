...
ALL : "$(OUTDIR)\testappnt.exe" "$(DS_POSTBUILD_DEP)"

!ELSE 

ALL : "apr_app - Win32 Release" "apr - Win32 Release" "$(OUTDIR)\testappnt.exe" "$(DS_POSTBUILD_DEP)"
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /O2 /I "../include" /D "NDEBUG" /D "WIN32" /D "WINNT" /D "_CONSOLE" /D "APR_DECLARE_STATIC" /D "APU_DECLARE_STATIC" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\testappnt" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib wsock32.lib ws2_32.lib /nologo /entry:"wmainCRTStartup" /subsystem:console /incremental:no /pdb:"$(OUTDIR)\testappnt.pdb" /machine:IX86 /out:"$(OUTDIR)\testappnt.exe" 
LINK32_OBJS= \
	"$(INTDIR)\testappnt.obj" \
	"..\LibR\apr-1.lib" \
	"..\build\LibR\apr_app-1.lib"
...
"$(DS_POSTBUILD_DEP)" : "$(OUTDIR)\testappnt.exe"
   if exist .\testappnt.exe.manifest mt.exe -manifest .\testappnt.exe.manifest -outputresource:.\testappnt.exe;2
...
ALL : "apr_app - Win32 Debug" "apr - Win32 Debug" "$(OUTDIR)\testappnt.exe" "$(DS_POSTBUILD_DEP)"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib wsock32.lib ws2_32.lib /nologo /entry:"wmainCRTStartup" /subsystem:console /incremental:no /pdb:"$(OUTDIR)\testappnt.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\testappnt.exe" 
LINK32_OBJS= \
	"$(INTDIR)\testappnt.obj" \
	"..\LibD\apr-1.lib" \
	"..\build\LibD\apr_app-1.lib"
...
CPP_SWITCHES=/nologo /MD /W3 /O2 /I "../include" /D "NDEBUG" /D "WIN32" /D "WINNT" /D "_CONSOLE" /D "APR_DECLARE_STATIC" /D "APU_DECLARE_STATIC" /Fo"$(INTDIR)\testappnt" /Fd"$(INTDIR)\testappnt" /FD /c 
