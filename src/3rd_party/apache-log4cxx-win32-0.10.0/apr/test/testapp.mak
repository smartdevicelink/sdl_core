...
ALL : "$(OUTDIR)\testapp.exe" "$(DS_POSTBUILD_DEP)"

!ELSE 

ALL : "apr_app - Win32 Release" "apr - Win32 Release" "$(OUTDIR)\testapp.exe" "$(DS_POSTBUILD_DEP)"
...
CPP=cl.exe
CPP_PROJ=/nologo /MD /W3 /O2 /I "../include" /D "NDEBUG" /D "WIN32" /D "_CONSOLE" /D "APR_DECLARE_STATIC" /D "APU_DECLARE_STATIC" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\testapp" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib wsock32.lib ws2_32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\testapp.pdb" /machine:IX86 /out:"$(OUTDIR)\testapp.exe" 
LINK32_OBJS= \
	"$(INTDIR)\testapp.obj" \
	"..\LibR\apr-1.lib" \
...
"$(DS_POSTBUILD_DEP)" : "$(OUTDIR)\testapp.exe"
   if exist .\testapp.exe.manifest mt.exe -manifest .\testapp.exe.manifest -outputresource:.\testapp.exe;2
...
ALL : "apr_app - Win32 Debug" "apr - Win32 Debug" "$(OUTDIR)\testapp.exe" "$(DS_POSTBUILD_DEP)"
...
LINK32=link.exe
LINK32_FLAGS=kernel32.lib advapi32.lib wsock32.lib ws2_32.lib /nologo /subsystem:console /incremental:no /pdb:"$(OUTDIR)\testapp.pdb" /debug /machine:IX86 /out:"$(OUTDIR)\testapp.exe" 
LINK32_OBJS= \
	"$(INTDIR)\testapp.obj" \
	"..\LibD\apr-1.lib" \
