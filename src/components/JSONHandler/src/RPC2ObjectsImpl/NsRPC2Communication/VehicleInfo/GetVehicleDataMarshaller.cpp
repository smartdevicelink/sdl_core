...
{
  if(!NsAppLinkRPC::VehicleDataTypeMarshaller::checkIntegrityConst(s.dataType))  return false;
...
Json::Value GetVehicleDataMarshaller::toJSON(const GetVehicleData& e)
{
  ...
  json["method"]=Json::Value("AppLinkCore.GetVehicleData");

  json["id"]=Json::Value(e.getId());
  json["params"]=Json::Value(Json::objectValue);
  json["params"]["dataType"]=NsAppLinkRPC::VehicleDataTypeMarshaller::toJSON(e.dataType);;
...
bool GetVehicleDataMarshaller::fromJSON(const Json::Value& json,GetVehicleData& c)
{
  try
  {
    ...
    if(!json.isMember("method") || !json["method"].isString() || json["method"].asString().compare("AppLinkCore.GetVehicleData"))  return false;
    ...
    if(!js.isMember("dataType") || !NsAppLinkRPC::VehicleDataTypeMarshaller::fromJSON(js["dataType"],c.dataType))  return false;
