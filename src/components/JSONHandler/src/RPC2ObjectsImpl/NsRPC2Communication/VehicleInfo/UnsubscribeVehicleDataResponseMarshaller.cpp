...
bool UnsubscribeVehicleDataResponseMarshaller::checkIntegrity(UnsubscribeVehicleDataResponse& s)
{
  return checkIntegrityConst(s);
}


bool UnsubscribeVehicleDataResponseMarshaller::fromString(const std::string& s,UnsubscribeVehicleDataResponse& e)
{
  try
  {
    Json::Reader reader;
...
const std::string UnsubscribeVehicleDataResponseMarshaller::toString(const UnsubscribeVehicleDataResponse& e)
{
...
bool UnsubscribeVehicleDataResponseMarshaller::checkIntegrityConst(const UnsubscribeVehicleDataResponse& s)
{
  if(s.dataResult)
  {
...
Json::Value UnsubscribeVehicleDataResponseMarshaller::toJSON(const UnsubscribeVehicleDataResponse& e)
{
...
bool UnsubscribeVehicleDataResponseMarshaller::fromJSON(const Json::Value& json,UnsubscribeVehicleDataResponse& c)
{
  try
  {
