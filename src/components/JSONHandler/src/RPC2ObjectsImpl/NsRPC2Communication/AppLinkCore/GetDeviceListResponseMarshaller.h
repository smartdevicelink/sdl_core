#ifndef NSRPC2COMMUNICATION_APPLINKCORE_GETDEVICELISTRESPONSEMARSHALLER_INCLUDE
#define NSRPC2COMMUNICATION_APPLINKCORE_GETDEVICELISTRESPONSEMARSHALLER_INCLUDE
