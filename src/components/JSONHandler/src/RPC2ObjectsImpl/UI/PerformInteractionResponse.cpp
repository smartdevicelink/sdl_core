...
PerformInteractionResponse::PerformInteractionResponse(void) : 
  RPC2Response(Marshaller::METHOD_PERFORMINTERACTIONRESPONSE),
  choiceID(0),
  triggerSource(0)
{
}
...
PerformInteractionResponse::PerformInteractionResponse(const PerformInteractionResponse& c) : RPC2Response(Marshaller::METHOD_PERFORMINTERACTIONRESPONSE,c.getId(),c.getResult())
{
  *this=c;
}
...
const TriggerSource* PerformInteractionResponse::get_triggerSource(void)
{
  return triggerSource;
}

bool PerformInteractionResponse::set_triggerSource(const TriggerSource& triggerSource_)
{
  if(triggerSource)  delete triggerSource;
