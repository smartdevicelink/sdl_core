...
bool AddSubMenu_v2_responseMarshaller::checkIntegrity(AddSubMenu_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool AddSubMenu_v2_responseMarshaller::fromString(const std::string& s,AddSubMenu_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string AddSubMenu_v2_responseMarshaller::toString(const AddSubMenu_v2_response& e)
{
...
bool AddSubMenu_v2_responseMarshaller::checkIntegrityConst(const AddSubMenu_v2_response& s)
{
...
Json::Value AddSubMenu_v2_responseMarshaller::toJSON(const AddSubMenu_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("AddSubMenu_v2");
...
bool AddSubMenu_v2_responseMarshaller::fromJSON(const Json::Value& js,AddSubMenu_v2_response& c)
{
  ...
  try
  {
    ...
    if(!j2.isMember("name") || !j2["name"].isString() || j2["name"].asString().compare("AddSubMenu_v2"))  return false;
