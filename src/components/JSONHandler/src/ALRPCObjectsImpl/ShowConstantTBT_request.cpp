...
ShowConstantTBT_request::ShowConstantTBT_request(const ShowConstantTBT_request& c)
{
  *this=c;
}
...
ShowConstantTBT_request::ShowConstantTBT_request(void) : ALRPCRequest(PROTOCOL_VERSION,Marshaller::METHOD_SHOWCONSTANTTBT_REQUEST),
      navigationText1(0),
    navigationText2(0),
    eta(0),
    totalDistance(0),
