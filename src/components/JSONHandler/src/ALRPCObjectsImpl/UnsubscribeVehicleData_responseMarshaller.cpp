...
Json::Value UnsubscribeVehicleData_responseMarshaller::toJSON(const UnsubscribeVehicleData_response& e)
{
  ...
  json["response"]["name"]=Json::Value("UnsubscribeVehicleData");
...
bool UnsubscribeVehicleData_responseMarshaller::fromJSON(const Json::Value& js,UnsubscribeVehicleData_response& c)
{
