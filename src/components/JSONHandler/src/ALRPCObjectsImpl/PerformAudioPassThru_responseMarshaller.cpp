...
Json::Value PerformAudioPassThru_responseMarshaller::toJSON(const PerformAudioPassThru_response& e)
{
  ...
  json["response"]["name"]=Json::Value("PerformAudioPassThru");
...
bool PerformAudioPassThru_responseMarshaller::fromJSON(const Json::Value& js,PerformAudioPassThru_response& c)
{
