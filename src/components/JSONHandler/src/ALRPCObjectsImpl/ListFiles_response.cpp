...
ListFiles_response::ListFiles_response(void) : ALRPCResponse(PROTOCOL_VERSION,Marshaller::METHOD_LISTFILES_RESPONSE),
      filenames(0),
    info(0)
{
}
...
bool ListFiles_response::set_resultCode(const Result_v2& resultCode_)
{
...
const Result_v2& ListFiles_response::get_resultCode(void) const 
{
  return resultCode;
}
