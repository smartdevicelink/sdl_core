...
bool Show_v2_responseMarshaller::checkIntegrity(Show_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool Show_v2_responseMarshaller::fromString(const std::string& s,Show_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string Show_v2_responseMarshaller::toString(const Show_v2_response& e)
{
...
bool Show_v2_responseMarshaller::checkIntegrityConst(const Show_v2_response& s)
{
...
Json::Value Show_v2_responseMarshaller::toJSON(const Show_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("Show_v2");
...
bool Show_v2_responseMarshaller::fromJSON(const Json::Value& js,Show_v2_response& c)
{
