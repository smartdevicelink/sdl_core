...
UpdateTurnList_response::UpdateTurnList_response(const UpdateTurnList_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
UpdateTurnList_response::UpdateTurnList_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
