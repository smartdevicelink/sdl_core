#ifndef NSAPPLINKRPCV2_HMILEVELMARSHALLER_INCLUDE
#define NSAPPLINKRPCV2_HMILEVELMARSHALLER_INCLUDE
...
#include "../include/JSONHandler/ALRPCObjects/V2/HMILevel.h"
