...
SetDisplayLayout_request::SetDisplayLayout_request(const SetDisplayLayout_request& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
SetDisplayLayout_request::SetDisplayLayout_request(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION)
{
}
