...
SetAppIcon_response::SetAppIcon_response(const SetAppIcon_response& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
SetAppIcon_response::SetAppIcon_response(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      info(0)
{
}
