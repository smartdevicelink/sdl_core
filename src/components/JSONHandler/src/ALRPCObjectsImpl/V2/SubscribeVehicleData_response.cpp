...
SubscribeVehicleData_response::SubscribeVehicleData_response(const SubscribeVehicleData_response& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
SubscribeVehicleData_response::SubscribeVehicleData_response(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      info(0),
    dataResult(0)
{
}
