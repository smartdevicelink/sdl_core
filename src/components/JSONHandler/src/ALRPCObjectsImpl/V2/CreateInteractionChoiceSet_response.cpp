...
CreateInteractionChoiceSet_response::CreateInteractionChoiceSet_response(const CreateInteractionChoiceSet_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
CreateInteractionChoiceSet_response::CreateInteractionChoiceSet_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
