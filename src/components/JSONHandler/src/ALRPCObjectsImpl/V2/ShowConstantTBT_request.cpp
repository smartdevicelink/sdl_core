...
ShowConstantTBT_request::ShowConstantTBT_request(const ShowConstantTBT_request& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
ShowConstantTBT_request::ShowConstantTBT_request(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      navigationText1(0),
    navigationText2(0),
    eta(0),
    totalDistance(0),
