...
AddSubMenu_response::AddSubMenu_response(const AddSubMenu_response& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
AddSubMenu_response::AddSubMenu_response(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      info(0)
{
}
