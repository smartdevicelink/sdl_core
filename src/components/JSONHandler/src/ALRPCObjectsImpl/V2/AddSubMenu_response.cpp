...
AddSubMenu_response::AddSubMenu_response(const AddSubMenu_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
AddSubMenu_response::AddSubMenu_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
