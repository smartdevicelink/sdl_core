...
UnsubscribeVehicleData_request::UnsubscribeVehicleData_request(const UnsubscribeVehicleData_request& c) : ALRPC2Message(c)
{
  *this=c;
}
...
UnsubscribeVehicleData_request::UnsubscribeVehicleData_request(void) : ALRPC2Message(PROTOCOL_VERSION)
{
}
