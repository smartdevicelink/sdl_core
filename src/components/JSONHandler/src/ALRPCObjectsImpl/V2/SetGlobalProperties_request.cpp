...
SetGlobalProperties_request::SetGlobalProperties_request(const SetGlobalProperties_request& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
SetGlobalProperties_request::SetGlobalProperties_request(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      helpPrompt(0),
    timeoutPrompt(0),
    vrHelpTitle(0),
    vrHelp(0)
