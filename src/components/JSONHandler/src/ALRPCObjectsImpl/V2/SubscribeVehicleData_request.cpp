...
SubscribeVehicleData_request::SubscribeVehicleData_request(const SubscribeVehicleData_request& c) : ALRPC2Message(c)
{
  *this=c;
}
...
SubscribeVehicleData_request::SubscribeVehicleData_request(void) : ALRPC2Message(PROTOCOL_VERSION)
{
}
