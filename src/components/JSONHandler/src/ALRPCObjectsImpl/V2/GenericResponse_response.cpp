...
GenericResponse_response::GenericResponse_response(const GenericResponse_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
GenericResponse_response::GenericResponse_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
