...
UnregisterAppInterface_response::UnregisterAppInterface_response(const UnregisterAppInterface_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
UnregisterAppInterface_response::UnregisterAppInterface_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
