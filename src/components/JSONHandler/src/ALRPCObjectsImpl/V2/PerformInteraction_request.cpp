...
PerformInteraction_request::PerformInteraction_request(const PerformInteraction_request& c) : ALRPC2Message(c)
{
  *this=c;
}
...
PerformInteraction_request::PerformInteraction_request(void) : ALRPC2Message(PROTOCOL_VERSION),
      helpPrompt(0),
    timeoutPrompt(0),
    timeout(0),
    vrHelp(0)
