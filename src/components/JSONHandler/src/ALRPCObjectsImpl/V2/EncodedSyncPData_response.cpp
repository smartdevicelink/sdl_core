...
EncodedSyncPData_response::EncodedSyncPData_response(const EncodedSyncPData_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
EncodedSyncPData_response::EncodedSyncPData_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
