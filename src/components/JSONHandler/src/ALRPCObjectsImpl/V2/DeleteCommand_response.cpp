...
DeleteCommand_response::DeleteCommand_response(const DeleteCommand_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
DeleteCommand_response::DeleteCommand_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
