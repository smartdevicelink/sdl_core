...
EndAudioPassThru_request::EndAudioPassThru_request(const EndAudioPassThru_request& c) : ALRPC2Message(c)
{
  *this=c;
}
...
EndAudioPassThru_request::EndAudioPassThru_request(void) : ALRPC2Message(PROTOCOL_VERSION)
{
}
