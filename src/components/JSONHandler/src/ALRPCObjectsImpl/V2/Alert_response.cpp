...
Alert_response::Alert_response(const Alert_response& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
Alert_response::Alert_response(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      info(0)
{
}
