...
EndAudioPassThru_response::EndAudioPassThru_response(const EndAudioPassThru_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
EndAudioPassThru_response::EndAudioPassThru_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
