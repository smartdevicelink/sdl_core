...
EndAudioPassThru_response::EndAudioPassThru_response(const EndAudioPassThru_response& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
EndAudioPassThru_response::EndAudioPassThru_response(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      info(0)
{
}
