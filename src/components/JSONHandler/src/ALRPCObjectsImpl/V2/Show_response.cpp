...
Show_response::Show_response(const Show_response& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
Show_response::Show_response(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      info(0)
{
}
