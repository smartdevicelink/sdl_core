...
DeleteFile_request::DeleteFile_request(const DeleteFile_request& c) : ALRPC2Message(c)
{
  *this=c;
}
...
DeleteFile_request::DeleteFile_request(void) : ALRPC2Message(PROTOCOL_VERSION)
{
}
