...
OnDriverDistraction::OnDriverDistraction(const OnDriverDistraction& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
OnDriverDistraction::OnDriverDistraction(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION)
{
}
