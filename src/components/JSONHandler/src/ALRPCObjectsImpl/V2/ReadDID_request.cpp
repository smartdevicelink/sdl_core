...
ReadDID_request::ReadDID_request(const ReadDID_request& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
ReadDID_request::ReadDID_request(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      encrypted(0)
{
}
