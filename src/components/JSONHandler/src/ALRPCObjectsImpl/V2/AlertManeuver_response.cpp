...
AlertManeuver_response::AlertManeuver_response(const AlertManeuver_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
AlertManeuver_response::AlertManeuver_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
