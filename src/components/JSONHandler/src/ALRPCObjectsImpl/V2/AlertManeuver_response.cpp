...
AlertManeuver_response::AlertManeuver_response(const AlertManeuver_response& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
AlertManeuver_response::AlertManeuver_response(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      info(0)
{
}
