...
AddCommand_response::AddCommand_response(const AddCommand_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
AddCommand_response::AddCommand_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
