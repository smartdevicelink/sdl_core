...
DeleteSubMenu_request::DeleteSubMenu_request(const DeleteSubMenu_request& c) : ALRPC2Message(c)
{
  *this=c;
}
...
DeleteSubMenu_request::DeleteSubMenu_request(void) : ALRPC2Message(PROTOCOL_VERSION)
{
}
