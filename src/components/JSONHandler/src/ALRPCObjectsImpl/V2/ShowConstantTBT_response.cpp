...
ShowConstantTBT_response::ShowConstantTBT_response(const ShowConstantTBT_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
ShowConstantTBT_response::ShowConstantTBT_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
