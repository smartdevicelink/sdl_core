...
DeleteInteractionChoiceSet_response::DeleteInteractionChoiceSet_response(const DeleteInteractionChoiceSet_response& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
DeleteInteractionChoiceSet_response::DeleteInteractionChoiceSet_response(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION),
      info(0)
{
}
