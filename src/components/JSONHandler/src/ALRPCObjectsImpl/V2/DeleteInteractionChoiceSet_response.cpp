...
DeleteInteractionChoiceSet_response::DeleteInteractionChoiceSet_response(const DeleteInteractionChoiceSet_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
DeleteInteractionChoiceSet_response::DeleteInteractionChoiceSet_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
