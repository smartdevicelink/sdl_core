...
UnsubscribeButton_response::UnsubscribeButton_response(const UnsubscribeButton_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
UnsubscribeButton_response::UnsubscribeButton_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      info(0)
{
}
