...
AlertManeuver_request::AlertManeuver_request(const AlertManeuver_request& c) : NsAppLinkRPC::ALRPCMessage(c)
{
  *this=c;
}
...
AlertManeuver_request::AlertManeuver_request(void) : NsAppLinkRPC::ALRPCMessage(PROTOCOL_VERSION)
{
}
