...
ListFiles_response::ListFiles_response(const ListFiles_response& c) : ALRPC2Message(c)
{
  *this=c;
}
...
ListFiles_response::ListFiles_response(void) : ALRPC2Message(PROTOCOL_VERSION),
      filenames(0),
    info(0)
{
}
