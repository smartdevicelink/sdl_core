...
bool UnsubscribeButton_v2_responseMarshaller::checkIntegrity(UnsubscribeButton_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool UnsubscribeButton_v2_responseMarshaller::fromString(const std::string& s,UnsubscribeButton_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string UnsubscribeButton_v2_responseMarshaller::toString(const UnsubscribeButton_v2_response& e)
{
...
bool UnsubscribeButton_v2_responseMarshaller::checkIntegrityConst(const UnsubscribeButton_v2_response& s)
{
...
Json::Value UnsubscribeButton_v2_responseMarshaller::toJSON(const UnsubscribeButton_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("UnsubscribeButton_v2");
...
bool UnsubscribeButton_v2_responseMarshaller::fromJSON(const Json::Value& js,UnsubscribeButton_v2_response& c)
{
  ...
  try
  {
    ...
    if(!j2.isMember("name") || !j2["name"].isString() || j2["name"].asString().compare("UnsubscribeButton_v2"))  return false;
