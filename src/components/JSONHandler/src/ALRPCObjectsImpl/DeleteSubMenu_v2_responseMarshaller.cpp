...
bool DeleteSubMenu_v2_responseMarshaller::checkIntegrity(DeleteSubMenu_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool DeleteSubMenu_v2_responseMarshaller::fromString(const std::string& s,DeleteSubMenu_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string DeleteSubMenu_v2_responseMarshaller::toString(const DeleteSubMenu_v2_response& e)
{
...
bool DeleteSubMenu_v2_responseMarshaller::checkIntegrityConst(const DeleteSubMenu_v2_response& s)
{
...
Json::Value DeleteSubMenu_v2_responseMarshaller::toJSON(const DeleteSubMenu_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("DeleteSubMenu_v2");
...
bool DeleteSubMenu_v2_responseMarshaller::fromJSON(const Json::Value& js,DeleteSubMenu_v2_response& c)
{
  ...
  try
  {
    ...
    if(!j2.isMember("name") || !j2["name"].isString() || j2["name"].asString().compare("DeleteSubMenu_v2"))  return false;
