...
bool ChangeLanguageRegistration_responseMarshaller::checkIntegrity(ChangeLanguageRegistration_response& s)
{
  return checkIntegrityConst(s);
}


bool ChangeLanguageRegistration_responseMarshaller::fromString(const std::string& s,ChangeLanguageRegistration_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string ChangeLanguageRegistration_responseMarshaller::toString(const ChangeLanguageRegistration_response& e)
{
...
bool ChangeLanguageRegistration_responseMarshaller::checkIntegrityConst(const ChangeLanguageRegistration_response& s)
{
...
Json::Value ChangeLanguageRegistration_responseMarshaller::toJSON(const ChangeLanguageRegistration_response& e)
{
  ...
  json["response"]["name"]=Json::Value("ChangeLanguageRegistration");
...
bool ChangeLanguageRegistration_responseMarshaller::fromJSON(const Json::Value& js,ChangeLanguageRegistration_response& c)
{
