#ifndef NSAPPLINKRPCV1_DISPLAYTYPEMARSHALLER_INCLUDE
#define NSAPPLINKRPCV1_DISPLAYTYPEMARSHALLER_INCLUDE
...
#include "../include/JSONHandler/ALRPCObjects/V1/DisplayType.h"
