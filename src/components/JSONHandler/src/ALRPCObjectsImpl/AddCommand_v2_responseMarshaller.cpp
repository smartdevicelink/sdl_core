...
bool AddCommand_v2_responseMarshaller::checkIntegrity(AddCommand_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool AddCommand_v2_responseMarshaller::fromString(const std::string& s,AddCommand_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string AddCommand_v2_responseMarshaller::toString(const AddCommand_v2_response& e)
{
...
bool AddCommand_v2_responseMarshaller::checkIntegrityConst(const AddCommand_v2_response& s)
{
...
Json::Value AddCommand_v2_responseMarshaller::toJSON(const AddCommand_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("AddCommand_v2");
...
bool AddCommand_v2_responseMarshaller::fromJSON(const Json::Value& js,AddCommand_v2_response& c)
{
