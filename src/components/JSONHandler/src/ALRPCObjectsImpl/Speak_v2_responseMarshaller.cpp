...
bool Speak_v2_responseMarshaller::checkIntegrity(Speak_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool Speak_v2_responseMarshaller::fromString(const std::string& s,Speak_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string Speak_v2_responseMarshaller::toString(const Speak_v2_response& e)
{
...
bool Speak_v2_responseMarshaller::checkIntegrityConst(const Speak_v2_response& s)
{
...
Json::Value Speak_v2_responseMarshaller::toJSON(const Speak_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("Speak_v2");
...
bool Speak_v2_responseMarshaller::fromJSON(const Json::Value& js,Speak_v2_response& c)
{
