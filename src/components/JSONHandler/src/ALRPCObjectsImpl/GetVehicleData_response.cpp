...
GetVehicleData_response::GetVehicleData_response(void) : ALRPCResponse(PROTOCOL_VERSION,Marshaller::METHOD_GETVEHICLEDATA_RESPONSE),
      info(0),
    gps(0),
    speed(0),
    rpm(0),
...
bool GetVehicleData_response::set_resultCode(const Result_v2& resultCode_)
{
...
const Result_v2& GetVehicleData_response::get_resultCode(void) const 
{
  return resultCode;
}
