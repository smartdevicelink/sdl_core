...
bool Alert_v2_responseMarshaller::checkIntegrity(Alert_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool Alert_v2_responseMarshaller::fromString(const std::string& s,Alert_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string Alert_v2_responseMarshaller::toString(const Alert_v2_response& e)
{
...
bool Alert_v2_responseMarshaller::checkIntegrityConst(const Alert_v2_response& s)
{
...
Json::Value Alert_v2_responseMarshaller::toJSON(const Alert_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("Alert_v2");
...
bool Alert_v2_responseMarshaller::fromJSON(const Json::Value& js,Alert_v2_response& c)
{
