...
bool SubscribeButton_v2_responseMarshaller::checkIntegrity(SubscribeButton_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool SubscribeButton_v2_responseMarshaller::fromString(const std::string& s,SubscribeButton_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string SubscribeButton_v2_responseMarshaller::toString(const SubscribeButton_v2_response& e)
{
...
bool SubscribeButton_v2_responseMarshaller::checkIntegrityConst(const SubscribeButton_v2_response& s)
{
...
Json::Value SubscribeButton_v2_responseMarshaller::toJSON(const SubscribeButton_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("SubscribeButton_v2");
...
bool SubscribeButton_v2_responseMarshaller::fromJSON(const Json::Value& js,SubscribeButton_v2_response& c)
{
