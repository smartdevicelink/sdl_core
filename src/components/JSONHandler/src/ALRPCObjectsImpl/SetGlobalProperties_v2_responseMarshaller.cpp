...
bool SetGlobalProperties_v2_responseMarshaller::checkIntegrity(SetGlobalProperties_v2_response& s)
{
  return checkIntegrityConst(s);
}


bool SetGlobalProperties_v2_responseMarshaller::fromString(const std::string& s,SetGlobalProperties_v2_response& e)
{
  try
  {
    Json::Reader reader;
...
const std::string SetGlobalProperties_v2_responseMarshaller::toString(const SetGlobalProperties_v2_response& e)
{
...
bool SetGlobalProperties_v2_responseMarshaller::checkIntegrityConst(const SetGlobalProperties_v2_response& s)
{
...
Json::Value SetGlobalProperties_v2_responseMarshaller::toJSON(const SetGlobalProperties_v2_response& e)
{
  ...
  json["response"]["name"]=Json::Value("SetGlobalProperties_v2");
...
bool SetGlobalProperties_v2_responseMarshaller::fromJSON(const Json::Value& js,SetGlobalProperties_v2_response& c)
{
  ...
  try
  {
    ...
    if(!j2.isMember("name") || !j2["name"].isString() || j2["name"].asString().compare("SetGlobalProperties_v2"))  return false;
