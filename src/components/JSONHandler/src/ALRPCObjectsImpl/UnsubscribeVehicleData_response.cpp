...
UnsubscribeVehicleData_response::UnsubscribeVehicleData_response(void) : ALRPCResponse(PROTOCOL_VERSION,Marshaller::METHOD_UNSUBSCRIBEVEHICLEDATA_RESPONSE),
      info(0),
    dataResult(0)
{
}
...
bool UnsubscribeVehicleData_response::set_resultCode(const Result_v2& resultCode_)
{
...
const Result_v2& UnsubscribeVehicleData_response::get_resultCode(void) const 
{
  return resultCode;
}
