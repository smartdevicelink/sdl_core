...
bool SetGlobalProperties_v2_requestMarshaller::checkIntegrity(SetGlobalProperties_v2_request& s)
{
  return checkIntegrityConst(s);
}


bool SetGlobalProperties_v2_requestMarshaller::fromString(const std::string& s,SetGlobalProperties_v2_request& e)
{
  try
  {
    Json::Reader reader;
...
const std::string SetGlobalProperties_v2_requestMarshaller::toString(const SetGlobalProperties_v2_request& e)
{
...
bool SetGlobalProperties_v2_requestMarshaller::checkIntegrityConst(const SetGlobalProperties_v2_request& s)
{
  if(s.helpPrompt)
  {
...
Json::Value SetGlobalProperties_v2_requestMarshaller::toJSON(const SetGlobalProperties_v2_request& e)
{
  ...
  json["request"]["name"]=Json::Value("SetGlobalProperties_v2");
...
bool SetGlobalProperties_v2_requestMarshaller::fromJSON(const Json::Value& js,SetGlobalProperties_v2_request& c)
{
