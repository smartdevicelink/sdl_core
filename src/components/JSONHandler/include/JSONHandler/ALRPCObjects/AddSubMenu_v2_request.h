#ifndef NSAPPLINKRPC_ADDSUBMENU_V2_REQUEST_INCLUDE
#define NSAPPLINKRPC_ADDSUBMENU_V2_REQUEST_INCLUDE
...
///  Adds a sub menu to the in-application menu.
  ...
  class AddSubMenu_v2_request : public ALRPCRequest
  {
  public:
  
    AddSubMenu_v2_request(const AddSubMenu_v2_request& c);
    AddSubMenu_v2_request(void);
    
    virtual ~AddSubMenu_v2_request(void);
  
    AddSubMenu_v2_request& operator =(const AddSubMenu_v2_request&);
  ...
  private:
    ...
    friend class AddSubMenu_v2_requestMarshaller;
