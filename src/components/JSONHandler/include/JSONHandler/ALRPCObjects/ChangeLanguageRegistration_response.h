#ifndef NSAPPLINKRPC_CHANGELANGUAGEREGISTRATION_RESPONSE_INCLUDE
#define NSAPPLINKRPC_CHANGELANGUAGEREGISTRATION_RESPONSE_INCLUDE
...
namespace NsAppLinkRPC
{
  ...
  class ChangeLanguageRegistration_response : public ALRPCResponse
  {
  public:
