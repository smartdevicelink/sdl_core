#ifndef NSAPPLINKRPCV2_PERFORMINTERACTION_REQUEST_INCLUDE
#define NSAPPLINKRPCV2_PERFORMINTERACTION_REQUEST_INCLUDE
...
///  Triggers an interaction (e.g. "Permit GPS?" - Yes, no, Always Allow).
  ...
  class PerformInteraction_request : public NsAppLinkRPC::ALRPCMessage
  {
  public:
