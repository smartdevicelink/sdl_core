#ifndef NSAPPLINKRPCV2_GETVEHICLEDATA_RESPONSE_INCLUDE
#define NSAPPLINKRPCV2_GETVEHICLEDATA_RESPONSE_INCLUDE
...
{
    class GetVehicleData_response : public NsAppLinkRPC::ALRPCResponse
    {
    public:
