#ifndef NSAPPLINKRPCV2_DELETECOMMAND_RESPONSE_INCLUDE
#define NSAPPLINKRPCV2_DELETECOMMAND_RESPONSE_INCLUDE
...
{
    class DeleteCommand_response : public NsAppLinkRPC::ALRPCResponse
    {
    public:
