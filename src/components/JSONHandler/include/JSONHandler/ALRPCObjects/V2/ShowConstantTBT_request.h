#ifndef NSAPPLINKRPCV2_SHOWCONSTANTTBT_REQUEST_INCLUDE
#define NSAPPLINKRPCV2_SHOWCONSTANTTBT_REQUEST_INCLUDE
...
namespace NsAppLinkRPCV2
{
  ...
  class ShowConstantTBT_request : public NsAppLinkRPC::ALRPCMessage
  {
  public:
