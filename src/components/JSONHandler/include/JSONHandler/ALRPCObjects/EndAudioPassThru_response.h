#ifndef NSAPPLINKRPC_ENDAUDIOPASSTHRU_RESPONSE_INCLUDE
#define NSAPPLINKRPC_ENDAUDIOPASSTHRU_RESPONSE_INCLUDE
...
namespace NsAppLinkRPC
{
  ...
  class EndAudioPassThru_response : public ALRPCResponse
  {
  public:
