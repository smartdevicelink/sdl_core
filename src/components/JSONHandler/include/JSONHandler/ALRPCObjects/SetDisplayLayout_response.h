#ifndef NSAPPLINKRPC_SETDISPLAYLAYOUT_RESPONSE_INCLUDE
#define NSAPPLINKRPC_SETDISPLAYLAYOUT_RESPONSE_INCLUDE
...
namespace NsAppLinkRPC
{
  ...
  class SetDisplayLayout_response : public ALRPCResponse
  {
  public:
