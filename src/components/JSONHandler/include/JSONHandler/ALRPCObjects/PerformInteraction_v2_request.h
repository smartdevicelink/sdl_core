#ifndef NSAPPLINKRPC_PERFORMINTERACTION_V2_REQUEST_INCLUDE
#define NSAPPLINKRPC_PERFORMINTERACTION_V2_REQUEST_INCLUDE
...
///  Triggers an interaction (e.g. "Permit GPS?" - Yes, no, Always Allow).
  ...
  class PerformInteraction_v2_request : public ALRPCRequest
  {
  public:
  
    PerformInteraction_v2_request(const PerformInteraction_v2_request& c);
    PerformInteraction_v2_request(void);
    
    virtual ~PerformInteraction_v2_request(void);
  
    PerformInteraction_v2_request& operator =(const PerformInteraction_v2_request&);
  ...
  private:
    ...
    friend class PerformInteraction_v2_requestMarshaller;
