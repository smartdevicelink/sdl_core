#ifndef NSAPPLINKRPC_SHOW_V2_REQUEST_INCLUDE
#define NSAPPLINKRPC_SHOW_V2_REQUEST_INCLUDE
...
///  Updates the persistent display. Supported fields depend on display capabilities.
  ...
  class Show_v2_request : public ALRPCRequest
  {
  public:
  
    Show_v2_request(const Show_v2_request& c);
    Show_v2_request(void);
    
    virtual ~Show_v2_request(void);
  
    Show_v2_request& operator =(const Show_v2_request&);
  ...
  private:
    ...
    friend class Show_v2_requestMarshaller;
