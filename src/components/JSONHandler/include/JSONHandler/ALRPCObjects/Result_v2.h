#ifndef NSAPPLINKRPC_RESULT_V2_INCLUDE
#define NSAPPLINKRPC_RESULT_V2_INCLUDE
...
///  The RPC (e.g. SubscribeVehicleData) executed successfully but one or more items have a warning or failure.
    ...
    Result_v2() : mInternal(INVALID_ENUM)				{}
    Result_v2(Result_v2Internal e) : mInternal(e)		{}
  
    Result_v2Internal get(void) const	{ return mInternal; }
    void set(Result_v2Internal e)		{ mInternal=e; }
  
  private:
    Result_v2Internal mInternal;
    friend class Result_v2Marshaller;
  };
