#ifndef RPC2COMMUNICATION_UI_SHOW_INCLUDE
#define RPC2COMMUNICATION_UI_SHOW_INCLUDE
...
namespace RPC2Communication
{
  namespace UI
  {
    ...
    class Show : public ::RPC2Communication::RPC2Request
    {
    public:
...
// getters
  ...
  const     ::AppLinkRPC::TextAlignment* get_alignment(void);
...
/// mainField2 <= 500
      ...
      bool set_alignment(const ::AppLinkRPC::TextAlignment& alignment);
...
/// mediaTrack <= 500
    ...
    private:
      ...
      ::AppLinkRPC::TextAlignment* alignment;
