...
namespace RPC2Communication
{
  namespace VR
  {
    ...
    public:
      ...
      {
        METHOD_INVALID=-1,
        METHOD_ADDCOMMAND=42,
        METHOD_ADDCOMMANDRESPONSE=43,
        METHOD_DELETECOMMAND=44,
        METHOD_DELETECOMMANDRESPONSE=45,
        METHOD_GETCAPABILITIES=46,
        METHOD_GETCAPABILITIESRESPONSE=47,
        METHOD_ONCOMMAND=48
      };
