#ifndef RPC2COMMUNICATION_APPLINKCORE_ONAPPREGISTERED_INCLUDE
#define RPC2COMMUNICATION_APPLINKCORE_ONAPPREGISTERED_INCLUDE
...
namespace RPC2Communication
{
  namespace AppLinkCore
  {
    ...
    class OnAppRegistered : public ::RPC2Communication::RPC2Notification
    {
    public:
...
// getters
  ...
  const     std::vector< std::string>* get_vrSynonym(void);
      ...
      const ::AppLinkRPC::Language& get_languageDesired(void);
...
/// vrSynonym[] <= 40 ; 1 <= size <= 100
      ...
      bool set_languageDesired(const ::AppLinkRPC::Language& languageDesired);
    ...
    private:
      ...
      ::AppLinkRPC::Language languageDesired;
