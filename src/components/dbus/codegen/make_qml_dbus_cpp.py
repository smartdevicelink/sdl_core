...
arg_parser.add_argument('--headerfile', required=True)
arg_parser.add_argument('--sourcefile', required=True)
...
header_out = open(args.headerfile, "w")
source_out = open(args.sourcefile, "w")
header_name = os.path.basename(args.headerfile)

header_out.write("#ifndef QML_DBUS_AUTOGENERATED_HEADER_\n");
header_out.write("#define QML_DBUS_AUTOGENERATED_HEADER_\n\n");
