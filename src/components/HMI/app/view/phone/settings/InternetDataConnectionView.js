...
MFT.PhoneSettingsInternetDataConnectionView = Em.ContainerView.create({
	classNameBindings:	['MFT.States.phone.phoneSettings.internetDataConnection.active:active_state','MFT.helpMode'],
	classNames:		   ['hidden'],
