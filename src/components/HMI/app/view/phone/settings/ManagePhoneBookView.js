...
MFT.PhoneSettingsManagePhoneBookView = Em.ContainerView.create({
	classNameBindings:	['MFT.States.phone.phoneSettings.managePhoneBook.active:active_state','MFT.helpMode'],
	classNames:		   ['hidden'],
