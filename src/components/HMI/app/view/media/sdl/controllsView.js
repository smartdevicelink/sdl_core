...
MFT.SDLMediaControlls = Em.ContainerView
                .create( {
                                    ...
                                    .extend( {
                                        ...
                                        template: Em.Handlebars
                                                        .compile( '{{#with view}}'
                                                                        ...
                                                                        + '<div class="artist textLimit"{{bindAttr class="MFT.SDLModel.protocolVersion2State:hidden"}}>{{MFT.SDLAppController.model.appInfo.field3}}</div>'
                                                                        + '<div class="time"{{bindAttr class="MFT.SDLModel.protocolVersion2State:timeV2"}}>{{MFT.SDLAppController.model.appInfo.mediaClock}}</div>'
                                                                        + '<img class="cd_logo" {{bindAttr src="MFT.SDLAppController.model.appInfo.trackIcon" class="MFT.SDLModel.protocolVersion2State:cd_logoV2"}} />'
                                                                        + '</div>' + '{{/with}}' )
                                    } ),

                    Controls: Em.ContainerView
                                    .create( {
                                        ...
                                        classNameBindings: 'MFT.SDLModel.protocolVersion2State:player_controllsV2',
                    ...
                    tuneButtons: Em.ContainerView.create( {
                        ...
                        classNameBindings:
                            [
                                'MFT.SDLModel.protocolVersion2State::hidden'
                            ],
