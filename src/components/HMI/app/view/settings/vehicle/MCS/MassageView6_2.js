/**
 * @name MFT.seatsMassageView6_2
 * 
 * @desc MCS massage view component 6.2 for MFT application
 * 
 * @category	Views
 * @filesource	app/view/settings/vehicle/MCS/MassageView6_2.js
 * @version		2.0
 *
 * @author	Andriy Melnik	
 */

MFT.SeatsMassageView6_2 = Em.ContainerView.extend({

	classNameBindings: ['MFT.MCSController.seatsAdjustModeSwitching:hide'],

	classNames:	'seatsMassageContent',

	elementId: 	'seatsMassageView6_2',
			...
			var count = 0;
				for(var i in MFT.MCSController.mcsBlockSettingsDriver)
				{
					...
					if( MFT.MCSController.mcsBlockSettingsDriver[i].position - 1 == self.get('positionDriver') ){
						...
						self.set('textForCaptionDriver', 'Block ' + i  + ' Active');
			...
			var count = 0;
				for(var i in MFT.MCSController.mcsBlockSettingsPassenger)
				{
					...
					if( MFT.MCSController.mcsBlockSettingsPassenger[i].position - 1 == self.get('positionPassenger') ){
						...
						self.set('textForCaptionPassenger', 'Block ' + i  + ' Active');
	...
	customAdjust: Em.ContainerView.extend({
		...
		seatLabel: MFT.Label.extend({
			elementId:	'seatsMassageView6_2_seatLabel_custom',
			classNames:	'seatsMassageView6_2_seatLabel_custom',
			content:	function(){
		...
		blocks: Em.ContainerView.extend({
			...
			btn1: MFT.Button.extend( MFT.Dragable, {
				elementId:			'1',
			...
			btn2: MFT.Button.extend( MFT.Dragable, {
				elementId:			'2',
				classNames:			'btn btn-48 seatsMassageView_settingsBlock ',
				text:				'Block2',
				attributeBindings:	['style','position'],
			...
			btn3: MFT.Button.extend( MFT.Dragable, {
				elementId:			'3',
				classNames:			'btn btn-48 seatsMassageView_settingsBlock ',
				text:				'Block3',
				attributeBindings:	['style','position'],
		...
		settingsScreen: Em.ContainerView.extend({
			...
			seatLabel: MFT.Label.extend({
				elementId:	'seatsMassageView6_2_seatLabel',
				classNames:	'seatsMassageView6_2_seatLabel',
				content:	function(){
					if( 'driver' == MFT.MCSController.seat){
						return 'Driver';
					}else if( 'passenger' == MFT.MCSController.seat){
			...
			editMenu: MFT.Label.extend({
				...
				content:	function(){
					...
					return 'Edit menu (Block' + MFT.MCSController.get('mcsActiveBlockButton') + ')';
		...
		settingsScreen2: Em.ContainerView.extend({
			...
			adjusts: MFT.seatsAdjustView.extend({
				elementId:	'seatsMassageView6_2MCSOptions',
				classNameBindings: ['hide:hidden'],
			...
			upperLabel: MFT.Label.extend({
				elementId:	'seatsMassageView6_2_upperLabel',
				classNames:	'seatsMassageView6_2_upperLabel',
				content:	'Upper'
			}),

			middleLabel: MFT.Label.extend({
				elementId:	'seatsMassageView6_2_middleLabel',
				classNames:	'seatsMassageView6_2_middleLabel',
				content:	'Middle'
			}),

			lowerLabel: MFT.Label.extend({
				elementId:	'seatsMassageView6_2_lowerLabel',
				classNames:	'seatsMassageView6_2_lowerLabel',
				content:	'Lower'
			}),

			rearLabel: MFT.Label.extend({
				elementId:	'seatsMassageView6_2_rearLabel',
				classNames:	'seatsMassageView6_2_rearLabel',
				content:	'Rear'
			}),

			frontLabel: MFT.Label.extend({
				elementId:	'seatsMassageView6_2_frontLabel',
				classNames:	'seatsMassageView6_2_frontLabel',
				content:	'Front'
			}),
