/**
 * @name MFT.NavigationDestinationFreeWayView
 * 
 * @desc Navigation Destination Free Way module visual representation
 * 
 * @category	View
 * @filesource	app/view/navigation/destination/FreeWayView.js
 * @version		2.0
 *
 * @author		Maksym Gerashchenko
 */

MFT.NavigationDestinationFreeWayView = Em.ContainerView.create({
	...
	heading: MFT.Label.extend({
		elementId: 'navigation_destination_freeWay_title',
		classNames: 'block-header-title',
		contentBinding:  Ember.Binding.oneWay('MFT.locale.label.view_navi_destination_Freeway_header')
	}),
	...
	content: Em.View.create({
		...
		template: Ember.Handlebars.compile(
			...
			'<div class="label-20 disabled freeway">{{MFT.locale.label.view_navi_destination_Freeway_freeway}}</div>'+
