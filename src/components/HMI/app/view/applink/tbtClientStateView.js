 ...
 * 
 * @category    View
 * @filesource  app/view/applink/TBTClientStateView.js
 * @version     2.0
 *
...
MFT.TBTClientStateView = Em.ContainerView.create({
    ...
    tbtClientStateSelect : Em.Select.extend({
        ...
        contentBinding:     'MFT.ApplinkModel.tbtClientStates',
        ...
        click: function(){
            ...
            MFT.ApplinkController.tbtClientStateSeleced( this.selection.name );
