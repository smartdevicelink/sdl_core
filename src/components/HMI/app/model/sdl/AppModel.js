...
MFT.SDLAppModel = Em.Object.extend({
	...
	/**
	 * SDL UI PreformInteraction response handeler
	...
	/**
	 * SDL UI CreateInteraction response handeler
	...
	/**
	 * SDL UI DeleteInteraction response handeler
	...
	/**
	 * SDL UI Slider response handeler
