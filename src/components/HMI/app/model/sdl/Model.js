...
MFT.SDLModel = Em.Object.create({
    ...
    /**
     * SDL UI ScrolableMessage activation function
    ...
    /**
     * SDL UI Alert Maneuver response handler
     * show popup window 
     *
     * @param {Object} message Object with parameters come from SDLCore
     */
    ...
    /**
     * SDL UI PerformInteraction response handler
     * show popup window 
     *
     * @param {Object} message Object with parameters come from SDLCore
    ...
    /**
     * SDL UI Slider response handler
     * show popup window 
     *
     * @param {Object} message Object with parameters come from SDLCore
     */
    ...
    /**
     * SDL UI AudioPassThru response handler
     * show popup window 
     *
     * @param {Object} message Object with parameters come from SDLCore.
     */
    ...
    /**
    * SDL VR AddCommand response handler
    ...
    */
    ...
    /**
    * SDL VR DeleteCommand response handler
