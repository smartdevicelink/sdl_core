/**
 * @name MFT.SettingsData1_4
 * 
 * @desc  Multi contour seat data
 * 
 * @category model	
 * @filesource app/model/SettingsData1_4.js	
 * @version		2.0
 *
 * @author	Melnik Andriy		
 */

MFT.SettingsData1_4 = Em.Object.extend({
	...
	driverSeat: {
		...
		6: MFT.RangedValue.create({range: 4, value:0, cycle: false, minValue: 0}),
