/**
 * @name MFT.SettingsData1_1
 * 
 * @desc  Multi contour seat data
 * 
 * @category model	
 * @filesource app/model/SettingsData1_1.js	
 * @version		2.0
 *
 * @author	Melnik Andriy		
 */

MFT.SettingsData1_1 = Em.Object.extend({
	...
	driverSeat: {
		...
		7: MFT.RangedValue.create({range: 3, value:0, cycle: false, minValue: 0}),

		8: MFT.RangedValue.create({range: 3, value:0, cycle: false, minValue: 0}),

		9: MFT.RangedValue.create({range: 3, value:0, cycle: false, minValue: 0}),

		10: MFT.RangedValue.create({range: 3, value:0, cycle: false, minValue: 0})
	},
