...
MFT.WebSocket = Em.Object.extend({
	...
	init: function ()
	{	
		MFT.WebSocketSimulator.addClient(this);
	},
     ...
     *	remove observer of Android messages on connection close
 	 */	
	close: function() { 
		MFT.WebSocketSimulator.removeClient(this);
	...
	send: function(jsonMessage) { 
		MFT.WebSocketSimulator.send(this.clientName, jsonMessage);
	},
