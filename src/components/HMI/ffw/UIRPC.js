	...
	onRPCRequest: function(request) {
		...
		switch (request.method) {
		    case "UI.Show":{
				...
				MFT.SDLController.getApplicationModel(request.params.appId).onSDLUIShow(request.params);
		    ...
		    case "UI.Alert":{
				...
				MFT.SDLModel.onUIAlert( request.params, request.id );

		    	break;
		    }
		    case "UI.SetGlobalProperties":{

				MFT.SDLModel.setProperties(request.params);
		    ...
		    case "UI.ResetGlobalProperties":{
				...
				MFT.SDLModel.resetProperties(request.params);
		    ...
		    case "UI.AddCommand":{
			    ...
			    MFT.SDLController.getApplicationModel(request.params.appId).addCommand(request.params);
		    ...
		    case "UI.DeleteCommand":{
				...
				MFT.SDLController.getApplicationModel(request.params.appId).deleteCommand(request.params.cmdId);
		    ...
		    case "UI.AddSubMenu":{
				...
				MFT.SDLController.getApplicationModel(request.params.appId).addSubMenu(request.params);
		    ...
		    case "UI.DeleteSubMenu":{
				...
				var resultCode =  MFT.SDLController.getApplicationModel(request.params.appId).deleteSubMenu(request.params.menuId);
		    ...
		    case "UI.CreateInteractionChoiceSet":{
				...
				MFT.SDLController.getApplicationModel(request.params.appId).onCreateInteraction(request.params);
		    ...
		    case "UI.DeleteInteractionChoiceSet":{
				...
				MFT.SDLController.getApplicationModel(request.params.appId).onDeleteInteraction(request.params);
		    ...
		    case "UI.PerformInteraction":{
				...
				MFT.SDLModel.uiPerformInteraction( request.params, request.id );

		    	break;
		    }
		    case "UI.SetMediaClockTimer":{

				var resultCode = MFT.SDLController.getApplicationModel(request.params.appId).sdlSetMediaClockTimer(request.params);
		    ...
		    case "UI.Slider":{
				...
				MFT.SDLModel.uiSlider( request );

		    	break;
		    }
		    case "UI.ScrollableMessage":{

				MFT.SDLModel.onSDLScrolableMessage( request.params, request.id );

		    	break;
		    }
		    case "UI.ChangeRegistration":{

				MFT.SDLModel.changeRegistrationUI( request.params.hmiDisplayLanguage );
		    ...
		    case "UI.SetAppIcon":{
				...
				MFT.SDLModel.onSDLSetAppIcon( request.params, request.id, request.method );
		    ...
		    case "UI.PerformAudioPassThru":{
				...
				MFT.SDLModel.UIPerformAudioPassThru( request.params );
		    ...
		    case "UI.EndAudioPassThru":{
				...
				MFT.SDLModel.UIEndAudioPassThru();
		    ...
		    case "UI.ShowConstantTBT":{
				...
				MFT.SDLModel.tbtActivate( request.params );
		    ...
		    case "UI.UpdateTurnList":{
				...
				MFT.SDLModel.tbtTurnListUpdate( request.params );
		    ...
		    case "UI.AlertManeuver":{
				...
				MFT.SDLModel.onUIAlertManeuver( request.params );
		    ...
		    case "UI.DialNumber":{
				...
				MFT.SDLModel.dialNumber( request.params );
