/*
 * com_botnar_sample_MessageBrokerWrapper.cpp
 *
...
#include "com_ford_avatar_jsonserver_MBWrapper.h"
...
void InvokeJSONServerSend(jint fd, jstring msg)
{
	...
	jclass clMBWrapper = penv->GetObjectClass(clObj);//penv->FindClass("com/ford/avatar/jsonserver/JSONServer");//penv->GetObjectClass(clObj);
	if(clMBWrapper == NULL)
	{
		return;
	}
...
/*
 * Class:     com_ford_avatar_jsonserver_MBWrapper
 * Method:    CreateInstance
 * Signature: ()Ljava/lang/Object;
 */
JNIEXPORT jboolean JNICALL Java_com_ford_avatar_jsonserver_MBWrapper_CreateInstance
 ...
 */
JNIEXPORT void JNICALL Java_com_ford_avatar_jsonserver_MBWrapper_StartMessageBroker
 ...
 */
JNIEXPORT void JNICALL Java_com_ford_avatar_jsonserver_MBWrapper_StopMessageBroker
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_ford_avatar_jsonserver_MBWrapper_DestroyMessageBroker
 ...
 */
JNIEXPORT void JNICALL Java_com_ford_avatar_jsonserver_MBWrapper_OnMessageReceived
 ...
 * Signature: (Ljava/lang/Object;)V
 */
JNIEXPORT void JNICALL Java_com_ford_avatar_jsonserver_MBWrapper_MethodForThread
