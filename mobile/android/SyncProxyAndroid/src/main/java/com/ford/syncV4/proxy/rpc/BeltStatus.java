    ...
    public VehicleDataEventStatus getDriverBeltDeployed() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.driverBeltDeployed, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getPassengerBeltDeployed() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.passengerBeltDeployed, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getPassengerBuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.passengerBuckleBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getDriverBuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.driverBuckleBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getLeftRow2BuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.leftRow2BuckleBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getPassengerChildDetected() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.passengerChildDetected, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getRightRow2BuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.rightRow2BuckleBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getMiddleRow2BuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.middleRow2BuckleBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getMiddleRow3BuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.middleRow3BuckleBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getLeftRow3BuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.leftRow3BuckleBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getRightRow3BuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.rightRow3BuckleBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getLeftRearInflatableBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.rearInflatableBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getRightRearInflatableBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.rightRearInflatableBelted, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getMiddleRow1BeltDeployed() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.middleRow1BeltDeployed, e);
            }
            return theCode;
        }
        return null;
    ...
    public VehicleDataEventStatus getMiddleRow1BuckleBelted() {
        ...
        if (obj instanceof VehicleDataEventStatus) {
            ...
            try {
                ...
                Logger.e("Failed to parse " + getClass().getSimpleName() + "." + Names.middleRow1BuckleBelted, e);
            }
            return theCode;
        }
        return null;
