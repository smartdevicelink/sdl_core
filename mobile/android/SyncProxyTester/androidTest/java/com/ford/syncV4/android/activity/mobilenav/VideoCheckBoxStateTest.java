...
public class VideoCheckBoxStateTest extends ActivityInstrumentationTestCase2<SyncProxyTester> {
    ...
    private VideoCheckBoxState mCheckBoxState;
    ...
    public void setUp() throws Exception {
        ...
        mCheckBoxState = new VideoCheckBoxState(new CheckBox(getActivity()), getActivity());
    }

    @UiThreadTest
    public void testInitialState() throws Exception {
        assertEquals("should have init text", mTextOn, mCheckBoxState.getItem().getText());
        assertEquals("should have video checkbox text", mTextOn, mCheckBoxState.getItem().getText());
    ...
    public void testStateOn() throws Exception {
        ...
        assertEquals("should have video streaming text", mTextOff, mCheckBoxState.getItem().getText());
        assertTrue("should be enabled", mCheckBoxState.getItem().isEnabled());
    ...
    public void testTransitionFromDisabledToOff() throws Exception {
        ...
        mCheckBoxState.setStateOff();
        assertEquals("should have init text", mTextOn, mCheckBoxState.getItem().getText());
        assertEquals("should have video checkbox text", mCheckBoxState.getItem().getText(), mTextOn);
        assertTrue("should be enabled", mCheckBoxState.getItem().isEnabled());
        assertEquals("should be at OFF state", mCheckBoxState.getState(), CheckBoxStateValue.OFF);
    }
}