...
namespace test { namespace components { namespace SmartObjects { namespace SchemaItem { namespace SchemaItemDraftTest {
    ...
    TEST(test_no_default_value, test_BoolSchemaItemTest)
    {
        ...
        NsAppLink::NsSmartObjects::TSharedPtr<NsAppLink::NsSmartObjects::CBoolSchemaItem> item = 
            NsAppLink::NsSmartObjects::CBoolSchemaItem::create(); // No default value
    ...
    TEST(test_item_with_default_value, test_BoolSchemaItemTest)
    {
        ...
        NsAppLink::NsSmartObjects::TSharedPtr<NsAppLink::NsSmartObjects::CBoolSchemaItem> item = 
            NsAppLink::NsSmartObjects::CBoolSchemaItem::create(false); // Default value = false
    ...
    TEST(test_array_validate, test_BoolSchemaItemTest)
    {
        NsAppLink::NsSmartObjects::CSmartObject obj;
        NsAppLink::NsSmartObjects::TSharedPtr<NsAppLink::NsSmartObjects::CBoolSchemaItem> item = 
            NsAppLink::NsSmartObjects::CBoolSchemaItem::create();
