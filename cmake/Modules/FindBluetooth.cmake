...
if (BLUETOOTH_LIBRARIES AND BLUETOOTH_INCLUDE_DIRS)
  ...
  if (BLUETOOTH_FOUND)
    if (NOT Bluetooth_FIND_QUIETLY)
      MESSAGE( STATUS "Found Bluetooth header file in ${BLUETOOTH_INCLUDE_DIR}")
      MESSAGE( STATUS "Found Bluetooth libraries: ${BLUETOOTH_LIBRARIES}")
    ...
    else( Bluetooth_FIND_REQUIRED)
      MESSAGE( STATUS "Optional package Bluetooth was not found" )
