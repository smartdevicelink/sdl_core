...
MFT.BalanceRangeBar = Em.ContainerView.extend({
    ...
    classNames:	['rangeBarContainer', 'balance'],
    ...
    Bar: Em.ContainerView.extend({
        ...
        Indicator: MFT.IndBalanceButton.extend({
            elementId:			    'indicatorBalance',
