...
MFT.SettingsData1_3 = Em.Object.extend({
	...
	driverSeat: {
		...
		5: MFT.RangedValue.create({range: 3, value:0, cycle: true, minValue: 0}),

		6: MFT.RangedValue.create({range: 3, value:0, cycle: false, minValue: 0}),

		7: MFT.RangedValue.create({range: 3, value:0, cycle: true, minValue: 0}),
