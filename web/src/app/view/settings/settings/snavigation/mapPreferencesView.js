...
MFT.SettingsSettingsNavigationMapPreferencesView = Em.ContainerView.create(MFT.LoadableView,{
	...
	backButton: MFT.Button.extend({
		elementId: 		   'settings_settings_navigation_mapPreferences_backButton',
	...
	topTitile: MFT.Label.extend({
		elementId:		   'settings_settings_navigation_mapPreferences_titile',
		classNames:		  ['block-header-title'],
		contentBinding:	  'MFT.locale.label.view_settings_settings_navigation_mapPreferences_title'
	}),				  
