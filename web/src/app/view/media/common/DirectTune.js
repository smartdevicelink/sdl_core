...
MFT.DirectTune = Em.ContainerView.create({
	...
	classNameBindings: [
        'MFT.MediaController.directTuneStations.length:visible',
        'MFT.MediaController.isSiriusDirectTunestations:visible',
    ...
    isHide: function () {
        return MFT.States.media.radio.am.options.active || MFT.States.media.radio.fm.options.active || MFT.States.media.radio.sirius.browse.active || MFT.States.media.radio.sirius.options.active;
