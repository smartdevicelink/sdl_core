...
MFT.siriusBrowseAllView = Em.ContainerView.create(MFT.LoadableView,{
	
	elementId: 'media_sirius_browseAll_view',
	...
	backButton: MFT.Button.extend({
		elementId: 			   'media_sirius_browseall_back_button',
	...
	heading: MFT.Label.extend({
		elementId: 'media_sirius_browseall_heading_lable',
	...
	list: MFT.List.extend({
		elementId: 'media_sirius_browseAll_list',
