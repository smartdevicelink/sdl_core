/**
 * @name MFT.cdBrowseAllView
 * 
 * @desc Browse All View visual representation
 * 
 * @category	View
 * @filesource	app/view/media/player/cd/browse/BrowseAllView.js
 * @version		2.0
 *
 * @author		Igot Zhavoronkin
 */

MFT.cdBrowseAllView = Em.ContainerView.create(MFT.LoadableView,{
	
	elementId: 'media_cd_browseAll_view',
	...
	backButton: MFT.Button.extend({
		elementId: 			   'media_cd_browseall_back_button',
	...
	heading: MFT.Label.extend({
		elementId: 'media_cd_browseall_heading_lable',
	...
	list: MFT.List.extend({
		elementId: 'media_cd_browseAll_list',
