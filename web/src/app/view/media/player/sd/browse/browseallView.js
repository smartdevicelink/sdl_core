/**
 * @name MFT.sdBrowseAllView
 * 
 * @desc Browse All View visual representation
 * 
 * @category	View
 * @filesource	app/view/media/player/sd/browse/BrowseAllView.js
 * @version		2.0
 *
 * @author		Igot Zhavoronkin
 */

MFT.sdBrowseAllView = Em.ContainerView.create(MFT.LoadableView,{
	
	elementId: 'media_sd_browseAll_view',
	...
	backButton: MFT.Button.extend({
		elementId: 			   'media_sd_browseall_back_button',
	...
	heading: MFT.Label.extend({
		elementId: 'media_sd_browseall_heading_lable',
	...
	list: MFT.List.extend({
		elementId: 'media_sd_browseAll_list',
