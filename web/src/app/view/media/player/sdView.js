 ...
 * @name MFT.SDView
 * 
 * @desc Media SD module visual representation
 * 
 * @category	View
 * @filesource	app/view/media/palyer/sdView.js
 * @version		2.0
 *
 * @author		Igor Zhavoronkin
 */
MFT.SDView = Em.ContainerView.create(MFT.LoadableView,{
	
	elementId: 'media_player_sd_view',
	...
	info: Em.View.extend({
		elementId: 'media_player_sd_view_info',
		...
		template: Em.Handlebars.compile(
			'<div class="track-info">'+
				...
				'<div id="cd_logo" {{bindAttr class="MFT.helpMode:helpmode"}}></div>'+
			'</div>'
		)
	}),
	...
	controlls: Em.ContainerView.extend({
		...
		elementId: 'media_player_sd_view_controlls',
		/** View components*/
		childViews: [
				'PrevTrackButton',
				'PlayButton',
		...
		PrevTrackButton: MFT.Button.extend({
			elementId: 			'media_player_sd_view_controlls_prev_track_button',
		...
		PlayButton: MFT.Button.extend({
			elementId: 			'media_player_sd_view_controlls_play_button',
		...
		NextTrackButton: MFT.Button.extend({
			elementId: 			'media_player_sd_view_controlls_next_track_button',
	...
	rightmenu:  Em.ContainerView.create({
		/** View ID */
		elementId:	'media_sd_rightmenu',
		
		/** Class Names */
		classNames: ['right-stock'],

        classNameBindings: [
            'MFT.States.media.player.sd.options.active:hidden',
            'MFT.States.media.player.sd.browse.active:hidden',
            'MFT.States.media.player.sd.moreinfo.active:hidden'
        ],
		/** View Components*/
		childViews: [
			'repeatButton',
		...
		repeatButton:  MFT.Button.extend({
			elementId: 'media_sd_rightmenu_repeatButton',
			classNames:			['rs-item'],
		...
		shuffleButton:  MFT.Button.extend({
			...
			elementId: 'media_sd_rightmenu_shuffleButton',
		...
		similarButton:  MFT.Button.extend({
			elementId:		'media_sd_rightmenu_similarButton',
		...
		moreInfoButton: MFT.Button.extend({
			...
			elementId: 'media_sd_rightmenu_moreinfoButton',
			action:			    'turnMoreInfo',
			target:				'MFT.MediaController',
			classNames:			['rs-item', 'helpmode_box_shadow'],
		...
		optionsButton: MFT.Button.extend({
			elementId:	'media_sd_rightmenu_optionButton',
			classNames:			['rs-item'],
			icon:				'images/media/active_arrow.png',
		...
		browseButton: MFT.Button.extend({
			...
			elementId:	'media_sd_rightmenu_browseButton',
			action:			   'turnOnBrowse',
			target:			   'MFT.MediaController',
			classNames:			['rs-item', 'helpmode_box_shadow'],
			icon:				'images/media/active_arrow.png',
