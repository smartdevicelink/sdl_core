 ...
 * 
 * @category	View
 * @filesource	app/view/media/player/usb/browseView.js
 * @version		2.0
 *
 * @author		Igor Zhavoronkin
 */

MFT.usbBrowseView = Em.ContainerView.create(MFT.LoadableView,{
	...
	heading: MFT.Label.extend({
		...
		classNames: 'title',
		contentBinding:  Ember.Binding.oneWay('MFT.locale.label.view_media_usb_browse_USBHardDisk')
	}),
