/**
 * @name MFT.usbMoreInfoView
 * 
 * @desc MoreInfoView module visual representation
 * 
 * @category	View
 * @filesource	app/view/media/player/usb/moreInfoView.js
 * @version		2.0
 *
 * @author		Maksym Gerashchenko
 */

MFT.usbMoreInfoView = Em.ContainerView.create(MFT.LoadableView,{
	
	elementId: 				 'media_usb_moreinfo',
	...
	backButton: MFT.Button.extend({
		elementId: 			 'media_usb_moreinfo_backButton',
	...
	title: MFT.Label.extend({
		elementId: 			 'media_usb_moreinfo_title',
	...
	whatsPlayingButton: 		MFT.Button.extend({
		elementId: 			 'media_usb_moreinfo_whatsplayingButton',
	...
	poster: Em.View.extend({
		elementId: 'media_usb_moreinfo_poster',
		template: Em.Handlebars.compile(
			'<div class="moreInfo_image">'+
				'<div id="usb_poster" {{bindAttr class="MFT.helpMode:helpmode"}}></div>'+
			'</div>'
		)
	}),
	...
	list: MFT.List.extend({
		...
		elementId: 'media_usb_moreinfo_list',
