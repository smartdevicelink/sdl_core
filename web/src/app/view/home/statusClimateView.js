...
MFT.StatusClimateView = Em.ContainerView.extend({
	...
	classNameBindings: [
        'MFT.States.climate.active:selected',
	...
	statusOff: Em.View.create({
		...
		template: Em.Handlebars.compile(
			'{{#if MFT.ClimateController.isOff}}<img class="key" src="images/climate/key.png"">{{MFT.locale.label.view_statusClimate_climate_off}}{{/if}}'
		)
	}),
