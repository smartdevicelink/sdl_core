...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # config.vm.synced_folder "path/on/host", "/full/path/inside/vm"
  ...
  # the file test_vagrant.pp in the manifests_path directory.
  #
  ...
  if Vagrant.has_plugin?("vagrant-proxyconf")
    config.proxy.http  = "http://spb-proxy.spb.luxoft.com:8080"
    config.proxy.https = "https://spb-proxy.spb.luxoft.com:8080"
    config.proxy.ftp   = "ftp://spb-proxy.spb.luxoft.com:8080"
  end
end
